...
Еще мы создадим поддомен cdn.example.com и с помощью CNAME-записи направим на технический домен, который нам выдаст CDN-ресурс чуть позже. Этот домен мы запишем в поле «Адрес сервера» в клиенте.
